              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i>Penyewaan<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= site_url('rentalling') ?>">Penyewaan ruko dan alat pembangunan</a></li>
                  ...
                  <li><a href="<?= site_url('#') ?>"><i class="fa fa-edit"></i>Pamsimas<span class="fa fa-chevron-right"></span></a></li>
